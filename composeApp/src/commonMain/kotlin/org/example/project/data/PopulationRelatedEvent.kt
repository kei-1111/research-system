...
val taisyo5BigFire = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "白玉製造所" to "旭町40番地の白玉製造所から出火し",
        "家屋乾燥" to "当時は炎天続きで家屋の乾燥が甚だしく",
        "運転休止" to "電車の十字街・地蔵町・鶴岡町・停車場前・大門前間と十字街・鶴岡町・真砂町・停車場前・若松橋間は5日まで運転が休止される",
        "炎天" to "当時は炎天続きで家屋の乾燥が甚だしく",
        "水道断水" to "水道断水中もあって942棟1763戸を焼失する",
    ),
    exception = """
...
val syowa9BigFire = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "防火地区" to "五．防火地区極めて尠く",
        "延焼" to "瞬時にして他に延焼拡大していった",
        "烈風" to "風速20余メートルにおよぶ東南の烈風に煽られて火勢劇烈を極め",
        "廃墟" to "的場町の間は全く廃墟に帰し",
        "粗悪\n木材家屋" to "四．発火地点及海岸付近は特に矮小粗悪木造家屋連担し且全市に亘り粗雑木造家屋が多かった事",
        "都市計画" to "公園等の都市計画上の施設が完備して居なかった事",
    ),
    exception = """
...
val yukawachoMerger = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "希望条件" to "10項目を希望条件とすることと決定した",
        "税金維持" to "5年間税金は現状維持とする希望条件が容れられず",
        "観光地" to "殊に早晩人家隣接するの趨勢に鑑み渾然一体となり相互に連絡統一ある施設を為し温泉地として将来観光地として諸設備を完成するは彼我の利益なりと認むるに因る",
        "詰問書" to "湯川町会には諮問案の形式で上程され",
        "都市計画" to "而も同町は市の都市計画区域に属し交通至便にして総て本市を中心に経済的機構を営み人情風俗は勿論実生活に於ても何等異なる処なき現象なるに行政区域を分ち諸般の施設を為すは得策ならず",
    ),
    exception = """
...
val hakodateAirRaid = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "太平洋戦争" to "太平洋戦争の終結もま近い昭和20年7月14、15日の両日",
        "艦載機" to "太平洋上の空母から発進したアメリカ軍の艦載機約2000は",
        "アメリカ海軍" to "フィリピンのレイテ湾を出港したアメリカ海軍の機動部隊は",
        "昭和20年" to "太平洋戦争の終結もま近い昭和20年7月14",
        "青函連絡船" to "本州と北海道を結ぶ青函連絡船の基地でもある函館市は大きな被害を受けた",
    ),
    exception = """
...
val toyamaruTyphoon = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "海底トンネル" to "本州と北海道を結ぶ海底トンネルの構想は",
        "津軽海峡" to "津軽海峡の大動脈として活躍した青函連絡船が",
        "船尾開口部" to "車両航送用の船尾開口部から車両甲板に海水が浸入",
        "台風15号" to "函館を襲った台風15号による洞爺丸",
        "青函連絡船" to "津軽海峡の大動脈として活躍した青函連絡船が",
    ),
    exception = """
...
val zenikamesawamuraMerger = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "財政力指数" to "財政力指数が他町村と比べて非常に弱く",
        "漁村設備" to "「地域振興計画」の内容は銭亀沢村が漁村であることが考えられていないこと",
        "上水道敷設" to "とくに上水道の敷設要望が強かったことをあげている",
        "住民投票" to "6月16日には銭亀沢村と村議会へ住民の意思を尊重し住民投票を求める陳情書が提出された",
        "合併" to "全国的に市町村合併が促進された昭和28年から29年にかけても銭亀沢村との合併はあまり話題にならなかった",
    ),
    exception = """
...
val kamedasiMerger = MajorEvent(
    ...
    characteristicWordMap = persistentMapOf(
        ...
        "自治振興" to "12月17日には町議会で「亀田町函館市自治振興調査特別委員会」（町議会議委員全員で構成）の設置が決まり",
        "住民運動" to "亀田市民による住民運動は",
        "函館市" to "字港地区の編入後も函館市から合併を働きかけられていた亀田村では",
        "住民投票" to "市民の生活を左右する合併問題は住民投票できめましょう",
        "合併" to "字港地区の編入後も函館市から合併を働きかけられていた亀田村では",
    ),
    exception = """
